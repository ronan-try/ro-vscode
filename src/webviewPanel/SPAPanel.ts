...
class SPAPanel {
	public static currentPanel: SPAPanel | undefined;
	...
	public static createOrShow(extensionUri: vscode.Uri, extensionPath: string) {
		...
		if (SPAPanel.currentPanel) {
			SPAPanel.currentPanel._panel.reveal(column);
			return;
		}
		...
		SPAPanel.currentPanel = new SPAPanel(panel, extensionUri, extensionPath);
	}
